...
import android.annotation.SuppressLint;//Sonradan eklendi
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        randomSayi = rndNumber.nextInt(5) +1;
    ...
    public void btnTahminEt(View v){
        gelenDeger = editTxtSayi.getText().toString() ;//klavyeden girilen sayıyı alır
        ...
        if(!TextUtils.isEmpty(gelenDeger)){
            if(kalanHak > 0  &&  tahminDogrumu == false){
                ...
                if(kalanHak ==0  && tahminDogrumu ==false)
                    sonucGoster("Kalan Hakkınız Bitti");
                editTxtSayi.setText(" ") ;
